...
<body>
	...
	<div class="main">
		<div class="navi">
			...
			<div class="naviBox">
				...
				<a href="/memberList.admin"
					class="list-group-item list-group-item-action list-group-item-secondary smallNavi active">회원
		...
		<div class="contentBox">
			<div class="contentTitle">회원 목록</div>
			<div class="content">
					...
					<div class="memberList">
						<c:choose>
							<c:when test="${fn:length(list) == 0}">
								<p style="text-align: center; margin-top: 20px; font-size: 18px;">표시할 회원이 없습니다.</p>
							</c:when>
							<c:otherwise>
