...
<body>
	<form action="/insert.qboard" method="post"
		...
		<div class="container col">
			...
			<div class="title_container" style="flex: 1; width: 100%">
				<div class="title_detail">
					<input type="text" id="title_input" style="margin-right: 5px;"
						placeholder="제목을 입력하세요."> <label for="secret"><input
						type="checkbox" id="secret">비밀글</label>
				</div>
			</div>
			...
			<div class="btns_container" style="flex: 1; width: 100%;">
				<button button id="insert_btn">작성완료</button>
			</div>
		</div>
	</form>
	<script>
